...
The goal of using a Random Forest Classifier is to identify and quantify the factors that influence the residential preferences of **Workers on-Site (WOS)** in the Roanoke Metropolitan Area. Here are the specific objectives Random Forest helps to achieve:
