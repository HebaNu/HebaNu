...
image: "WhereToLiveForInPersonWorkers.JPG"
---
...
![Residential location choices' factors for in-person workers](WhereToLiveForInPersonWorkers.JPG)
...
The goal of using a Random Forest Classifier is to identify and quantify the factors that influence the residential preferences of on-site workers in the Roanoke Metropolitan Area. Here are the specific objectives Random Forest helps to achieve:
...
-   *`In summary, your model’s output provides a useful guide to understanding which factors are most influential in determining living area preferences, with distance from work appearing as the most significant factor according to this model.]`*\
    \
