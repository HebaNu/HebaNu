...
X_poly = poly.fit_transform(data[['scaled_income']])
...
plt.scatter(y_test, y_pred_poly, alpha=0.5, color='red', label='Predicted')
plt.scatter(y_test, y_test, alpha=0.5, color='blue', label='Actual')

# Adding plot labels and title
plt.xlabel('Actual Living Area Preference')
